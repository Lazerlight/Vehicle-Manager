            ...
            if (ValidateForm())
            {
                using (SqlConnection con = new SqlConnection())
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand())
                    {
                        ...
                        cmd.CommandText = "insert into vehicle(Id, FuelType, litresPer100km, kmPerMonth, kmStartPerMonth, kmEndPerMonth, fuelChargedPerMonth, fuelBurnedPerMonth, vehicleCategory, Year, Month, Day, fuelLeft, company, driver, startingFuel, OMW, LUKOIL) values(N'" + carNumberValue.Text+"'," +
